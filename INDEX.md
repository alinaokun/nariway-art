...
- **[[what-becomes-of-great-art-collections|What Becomes of Great Art Collections]] — THE LIVING REPORT MANUSCRIPT** (the evolving content itself; open it to watch the report grow, changelog in the Production-notes section at the bottom). · [[flagship-report]] — the *plan and standards* behind it. · **[[collection-index]] — the knowledge-infrastructure direction** (the report dissolving into a web-native, continuously-maintained Collection Index; access model, guardrails, next steps).
