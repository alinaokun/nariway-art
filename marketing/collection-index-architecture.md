...
**Prototype 1 BUILT 2026-08-22** → the Collection Record at three evidence levels (Cisneros moderate / Barnes rich / Corcoran thin), as an artifact for critique: https://claude.ai/code/artifact/585e590c-0271-43d9-9752-b4cf43cd2fc8 . The real implementation lands in the `nariway-rebuild` website project; this is the visual prototype to react to. Next: Prototypes 2–4 after Alina's critique of #1.
