...
**Before finalizing:**
1. **Fact-check the Fisher number (priority, this is the rigor brand).** The concept says "placing **more than 1,000 works** there under a 100-year loan." The coded case ([[fisher-sfmoma]]) says **720+ works on loan** (SFMOMA, primary), with a **~1,100-work total collection** (secondary). "More than 1,000 works there" likely conflates the loan with the whole collection. Use the primary figure. A wrong number on the homepage undercuts the "we are rigorous" positioning the whole site rests on.
