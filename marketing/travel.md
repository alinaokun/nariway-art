...
- **Atlanta, GA — Sept 2 to 8, 2026.** The standout is not a museum, it is a relationship: the **Souls Grown Deep Foundation is headquartered in Atlanta**, and that is Alina's own case, the collection that gave itself away ([[souls-grown-deep]]). Worth exploring whether a visit or a conversation can be arranged, this is a possible discovery contact, not only a viewing. Also the **High Museum of Art** (strong American, folk, and self-taught holdings, has shown Souls Grown Deep works).
