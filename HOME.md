...
- Cases mapped, about 80. Coded to report grade, **44 of 50**, and a cloud agent now deepens the dataset daily on its own, whether the laptop is open or closed. WebFetch is still blocked on primary sources (ProPublica etc., confirmed again this run) — most recent cases remain secondary-sourced pending a re-fetch pass.
