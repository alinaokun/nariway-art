...
## The evidence-phase rhythm (2026-08, the learning engine)
Full model in [[operating-rhythm]]. Nariway's day is **Research · Talk · Write · Capture**, with one non-negotiable: **one outward-facing action every working day** (never five straight days inside the vault). Toi's standing questions shift from tasks to learning: **What did we learn? Who did we hear from? What are we writing? What should we test next?** And once a week the important one, **did anything change what we think?**, which is where [[what-we-now-believe]] evolves. The [[operating-rhythm|weekly scorecard]] measures conversations, relationships, new cases, and challenged assumptions, not followers, plus a standing willingness-to-pay signal so the learning engine stays pointed at a first paid engagement.
