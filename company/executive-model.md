...
flowchart TD
    ...
    FUN["⚙️ Functions — no personas<br/>Artobiography · Collection Intelligence · Models Scan · Institution Building · Case Research · Source Verification<br/>Signals · LinkedIn · Website · Substack · Travel & Logistics"]
...
- **Not named (named after the work instead):** Artobiography, Collection Intelligence, Models Scan, Institution Building, Case Research, Source Verification, Signals, LinkedIn, Website, Substack, Travel & Logistics. These are *what agents do*, not who they are.
