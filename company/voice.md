...
**Substack Notes.** A different grammar for the same sensibility, not a lesser dialect of the essays. Keep the curatorial judgment, the provenance detail, the restraint. Change the syntax. Short declarative lines with hard returns in place of the long comma-held sentences of the long-form. A specific hook in line one, plain and direct rather than casual. One idea. A landed statement at the end, never a closing question. The em-dash ban is free here, the line break does its work, and the colon is held the same way or allowed as a deliberate tool. Format details in [[substack]].
