...
## Gaps / contradictions
- **CORRECTION (2026-08-30, from an independent fact-check): the site chronology above is WRONG.** The correct order is San Francisco Presidio FIRST (Presidio Trust rejected the proposal Feb 3, 2014, on the grounds that no proposal was right for the location, not "design/height" alone), THEN the Chicago lakefront (announced 2014, abandoned June 2016 after the Friends of the Parks lawsuit), THEN Los Angeles (chosen January 2017). The coded `primary_friction` note has the Presidio dated 2016-2017 and after Chicago, which is incorrect. Sources: kqed.org/news/125195 (Presidio rejection, Feb 2014); theartnewspaper.com 2016-06-27 (Chicago abandoned after two-year battle); kqed.org/arts/12608778 (LA chosen 2017). Do not repeat the old ordering.
